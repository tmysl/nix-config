...
in
{
  ...
  boot.initrd.luks.devices."luks-d46fbf02-4061-46b6-a3d1-87462667bf4d".device = "/dev/disk/by-uuid/d46fbf02-4061-46b6-a3d1-87462667bf4d";
  networking.hostName = "johto"; # Define your hostname.
